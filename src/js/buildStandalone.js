...
const standalone_JS_Files = [
	'globalVariables', 'debug_off', 'font', 'rng', 'riffwave', 'editor/random_sound_generators', 'sfxr2', 'codemirror/stringstream', 'colors', 'graphics', 'engine/screen_layout',
	'engine/log', 'engine/message_screen', 'engine/level', 'engine/bitvec', 'engine/rule', 'engine/cell_pattern', 'engine/engine_base', 'compiler/identifiers', 'compiler/rule',
	'compiler/rule_parser', 'compiler/rule_expansion', 'compiler/rule_groups', 'parser', 'compiler', 'inputoutput', 'mobile'
]
